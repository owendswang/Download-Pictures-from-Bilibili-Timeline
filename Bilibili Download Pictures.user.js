...
(function() {
    ...
    function showListDownloadButton() {
        ...
        if ((window.location.host === 'space.bilibili.com' && window.location.pathname.match(/^\/\d+\/dynamic$/)) || (window.location.host === 't.bilibili.com') || (window.location.host === 'www.bilibili.com' && window.location.pathname.match(/^\/opus\/\d+$/))) {
